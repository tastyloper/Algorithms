...
//     if (splitArr[0] === 'Enter') {
//       pre = pre.map(v => v.uid === splitArr[1] ? { ...v, name: splitArr[2] } : v);
//       pre = [...pre, { state: 'Enter', uid: splitArr[1], name: splitArr[2] }];
//     } else if (splitArr[0] === 'Leave') {
//       pre = [...pre, { state: 'Leave', uid: splitArr[1], name: pre.find(v => v.uid === splitArr[1]).name }];
//     } else {
//       pre = pre.map(v => v.uid === splitArr[1] ? { ...v, name: splitArr[2] } : v);
//     }
//     return pre;
